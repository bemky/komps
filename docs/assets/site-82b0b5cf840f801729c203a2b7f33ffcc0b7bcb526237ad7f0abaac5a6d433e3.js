!function(){"use strict";function H(t,i,e,r,s={}){(e=Array.isArray(e)?e:[e]).forEach(e=>{t.addEventListener(e,e=>{e.target.matches(i)?(e.delegateTarget=e.target,r(e)):e.target.closest(i)&&(e.delegateTarget=e.target.closest(i),r(e))},s)})}const M=["accept","accept-charset","accesskey","action","align","allow","alt","async","autocapitalize","autocomplete","autofocus","autoplay","background","bgcolor","border","buffered","capture","challenge","charset","checked","cite","class","code","codebase","color","cols","colspan","content","contenteditable","contextmenu","controls","coords","crossorigin","csp","data","data-*","datetime","decoding","default","defer","dir","dirname","disabled","download","draggable","dropzone","enctype","enterkeyhint","for","form","formaction","formenctype","formmethod","formnovalidate","formtarget","headers","height","hidden","high","href","hreflang","http-equiv","icon","id","importance","integrity","intrinsicsize","inputmode","ismap","itemprop","keytype","kind","label","lang","language","loading","list","loop","low","manifest","max","maxlength","minlength","media","method","min","multiple","muted","name","novalidate","open","optimum","pattern","ping","placeholder","popover","popovertarget","popovertargetaction","poster","preload","radiogroup","readonly","referrerpolicy","rel","required","reversed","rows","rowspan","sandbox","scope","scoped","selected","shape","size","sizes","slot","span","spellcheck","src","srcdoc","srclang","srcset","start","step","style","summary","tabindex","target","title","translate","type","usemap","value","width","wrap","aria","aria-*","xmlns"],_=["disabled","readOnly","multiple","checked","autobuffer","autoplay","controls","loop","selected","hidden","scoped","async","defer","reversed","isMap","seemless","muted","required","autofocus","noValidate","formNoValidate","open","pubdate","itemscope","indeterminate"],j=["accent-height","accumulate","additive","alignment-baseline","alphabetic","amplitude","arabic-form","ascent","attributeName","attributeType","azimuth","baseFrequency","baseline-shift","baseProfile","bbox","begin","bias","by","calcMode","cap-height","class","clip","clipPathUnits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","crossorigin","cursor","cx","cy","d","decelerate","descent","diffuseConstant","direction","display","divisor","dominant-baseline","dur","dx","dy","edgeMode","elevation","enable-background","end","exponent","fill","fill-opacity","fill-rule","filter","filterUnits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","format","from","fr","fx","fy","g1","g2","glyph-name","glyph-orientation-horizontal","glyph-orientation-vertical","glyphRef","gradientTransform","gradientUnits","hanging","height","href","hreflang","horiz-adv-x","horiz-origin-x","id","ideographic","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kernelMatrix","kernelUnitLength","kerning","keyPoints","keySplines","keyTimes","lang","lengthAdjust","letter-spacing","lighting-color","limitingConeAngle","local","marker-end","marker-mid","marker-start","markerHeight","markerUnits","markerWidth","mask","maskContentUnits","maskUnits","mathematical","max","media","method","min","mode","name","numOctaves","offset","opacity","operator","order","orient","orientation","origin","overflow","overline-position","overline-thickness","panose-1","paint-order","path","pathLength","patternContentUnits","patternTransform","patternUnits","ping","pointer-events","points","pointsAtX","pointsAtY","pointsAtZ","preserveAlpha","preserveAspectRatio","primitiveUnits","r","radius","referrerPolicy","refX","refY","rel","rendering-intent","repeatCount","repeatDur","requiredExtensions","requiredFeatures","restart","result","rotate","rx","ry","scale","seed","shape-rendering","slope","spacing","specularConstant","specularExponent","speed","spreadMethod","startOffset","stdDeviation","stemh","stemv","stitchTiles","stop-color","stop-opacity","strikethrough-position","strikethrough-thickness","string","stroke","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke-width","style","surfaceScale","systemLanguage","tabindex","tableValues","target","targetX","targetY","text-anchor","text-decoration","text-rendering","textLength","to","transform","transform-origin","type","u1","u2","underline-position","underline-thickness","unicode","unicode-bidi","unicode-range","units-per-em","v-alphabetic","v-hanging","v-ideographic","v-mathematical","values","vector-effect","version","vert-adv-y","vert-origin-x","vert-origin-y","viewBox","visibility","width","widths","word-spacing","writing-mode","x","x-height","x1","x2","xChannelSelector","xlink:actuate","xlink:arcrole","xlink:href Deprecated","xlink:role","xlink:show","xlink:title","xlink:type","xml:base","xml:lang","xml:space","y","y1","y2","yChannelSelector","z","zoomAndPan"];function o(e,t){e.innerHTML="",l(e,t)}function $(t,i={}){Object.keys(i).forEach(e=>function t(i,r,s){s instanceof Promise?s.then(e=>t(i,r,e)):!1?(s.addListener(e=>t(i,r,e)),"content"==r?o(i,s.value):t(i,r,s.value)):"value"==r?i.value=s:"data"==r&&"object"==typeof s?Object.keys(s).forEach(e=>{i.dataset[e]="object"==typeof s[e]?JSON.stringify(s[e]):s[e]}):"style"==r&&"object"==typeof s?Object.keys(s).forEach(t=>{let e=s[t];(e,!1)&&(e.addListener(e=>{null===e?i.style.removeProperty(t):i.style.setProperty(t,e)}),e=e.value),null===e?i.style.removeProperty(t):i.style.setProperty(t,e)}):"content"==r||"children"==r?o(i,s):r.match(/^on[a-z]/)?i[r]=s:_.find(e=>e.toUpperCase()==r.toUpperCase())?(r=_.find(e=>e.toUpperCase()==r.toUpperCase()),i[r]=!1!==s):(M.find(e=>r.match(new RegExp(e)))||j.includes(r))&&i.setAttribute(r,s)}(t,e,i[e]))}function w(e="div",t={},i){"object"==typeof e&&("string"==typeof t&&(i=t),e=(t=e).tag||"div");let r;return"svg"==e&&(t.xmlns=t.xmlns||"http://www.w3.org/2000/svg"),$(r=t.xmlns||i?document.createElementNS(t.xmlns||i,e):document.createElement(e),t),r}function a(e,t){if(Array.isArray(t)||t instanceof NodeList||t instanceof HTMLCollection){for(var i=Array.from(t);0<i.length;)e=a(e,i.pop());return e}if(Array.isArray(e)||e instanceof NodeList||e instanceof HTMLCollection)return a(e[0],t);if(e.parentNode)return t instanceof Node||(t=new Text(t)),e.parentNode.insertBefore(t,e),t;throw"argument of insertBefore unsupported"}function F(e){return e instanceof NodeList||e instanceof Array||e instanceof HTMLCollection?(e=Array.from(e)).forEach(F):e.parentNode.removeChild(e),e}function l(t,i,r,s,n){if(n=n||"append",Array.isArray(i)||i instanceof NodeList||i instanceof HTMLCollection){let e=Array.from(i);(e="prepend"==n?e.reverse():e).forEach(e=>l(t,e,r,s,n))}else if(r instanceof Element){let e=Array.from(arguments).slice(1).filter(e=>e instanceof Element);(e="prepend"==n?e.reverse():e).forEach(e=>l(t,e,void 0,s,n))}else if("boolean"!=typeof r&&(s=r,r=void 0),null!=i){var e;if(i instanceof Promise||i.then){const o=document.createElement("span");return t[n](o),i.then(e=>{l(o,e,r,s),a(o,o.childNodes),F(o)})}return i instanceof Element||i instanceof Node?t[n](i):"function"==typeof i?l(t,i.bind(s)(t),r,s):"object"==typeof i?t[n](w(i,t.namespaceURI)):r?t[n](i):((e=document.createElement("div")).innerHTML=i,t[n](...e.childNodes))}}function h(e,t){return getComputedStyle(e).getPropertyValue(t)}function c(e,t){if(Array.isArray(t)||t instanceof NodeList||t instanceof HTMLCollection){for(var i=Array.from(t);0<i.length;)e=c(e,i.shift());return e}if(Array.isArray(e)||e instanceof NodeList||e instanceof HTMLCollection)return c(e[e.length-1],t);if(e.parentNode)return t instanceof Node||(t=new Text(t)),e.parentNode.insertBefore(t,e.nextSibling),t;throw"argument of insertAfter unsupported"}function d(...e){let t=e.pop(),i=e.pop();"string"==typeof i||Array.isArray(i)||(e=e.concat(i),i="click"),"string"!=typeof e[0]&&e.unshift("button");const r=w(...e);return(i=Array.isArray(i)?i:[i]).forEach(e=>r.addEventListener(e,t)),r}function q(e,t,i){i=Object.assign({bubbles:!0,cancelable:!0},i),e.dispatchEvent(new CustomEvent(t,i))}function B(e){return e&&e.constructor&&e.call&&e.apply}function W(e,t,i,r=!0){var[t,i]=[t,i].sort((e,t)=>e-t);return r?t<=e&&e<=i:t<e&&e<i}function n(e,t,...i){t=e[t];return B(t)?t.call(e,...i):t}function V(e,t){t(e);e=Object.getPrototypeOf(e);e&&V(e,t)}function e(e,t){let i=[];return V(e,e=>{e.hasOwnProperty(t)&&i.push(e[t])}),i}function x(e,t){if(!Array.isArray(e))return e;const i=[];return t=t||((e,t)=>!t.includes(e)),e.forEach(e=>{t(e,i)&&i.push(e)}),i}function U(e,t){return e.matches?e.matches(t)?e:e.closest(t):null}function K(e,i){const r={};return e.forEach(e=>{let t;t=B(i)?r[i(e)]:n(e,i),r[t]=r[t]||[],r[t].push(e)}),r}function Y(e,t){var i=[];let r=0,s="",n=!1;for(;r<e.length;){var o=e.at(r);'"'==o&&n&&e.at(r+1)==t?n=!1:'"'!=o||n||0!=r&&e.at(r-1)!=t?n||o!=t?s+=o:(i.push(s),s=""):n=!0,r++}return i.push(s),i}class t extends HTMLElement{static assignableAttributes=[];static assignableMethods=[];static bindMethods=[];static style="";static watch=[];static events=["afterRemove","beforeRemove","beforeConnect","afterConnect","beforeDisconnect","afterDisconnect"];static get observedAttributes(){return this.watch}static include(e){this._plugins||(this._plugins=[]),this._plugins.includes(e.name)||(this._plugins.push(e.name),e.call(this,this.prototype))}_assignableAttributes={};_attributes={};_cleanupCallbacks=[];is_initialized=!1;constructor(r={}){super();const s=Object.assign({},r);e(this.constructor,"bindMethods").filter(e=>e).reverse().forEach(e=>{e.forEach(e=>{this[e]=this[e].bind(this)})}),e(this.constructor,"assignableAttributes").filter(e=>e).reverse().forEach(e=>{Array.isArray(e)?e.forEach(e=>{this._assignableAttributes[e]=this._assignableAttributes[e]||null}):Object.assign(this._assignableAttributes,e)}),Object.keys(this._assignableAttributes).forEach(i=>{Object.defineProperty(this,i,{configurable:!0,get:()=>this._attributes[i],set:e=>{var t=this._attributes[i];e!==t&&(this._attributes[i]=e,this.attributeChangedCallback(i,t,e))}}),r.hasOwnProperty(i)?(this[i]=r[i],delete s[i]):this[i]=this._assignableAttributes[i]}),e(this.constructor,"assignableMethods").filter(e=>e).reverse().forEach(e=>{e.forEach(t=>{if(r.hasOwnProperty(t)&&"function"==typeof r[t]){const i=this[t];this[t]=function(...e){return e.push(i),r[t].call(this,...e)},delete s[t]}})}),e(this.constructor,"events").filter(e=>e).reverse().forEach(e=>{e.forEach(e=>{var t="on"+e[0].toUpperCase()+e.slice(1);r.hasOwnProperty(t)&&(this.addEventListener(e,r[t]),delete s[t])})}),Object.keys(s).forEach(e=>{null==s[e]&&delete s[e]}),$(this,s)}initialize(){Object.keys(this._assignableAttributes).forEach(e=>{var t=this.getAttribute(e)||this.dataset[e]||this[e];"content"==e&&t?(this.removeAttribute("content"),o(this,t)):null!==t&&(this[e]=t)})}connected(){}async connectedCallback(){if(this.trigger("beforeConnect"),this.appendStyle(),!this.is_initialized&&!this.initializing){if(!(this.initializing=!0)===await this.initialize())return;this.is_initialized=!0,delete this.initializing}this.connected(),this.trigger("afterConnect")}disconnected(){}disconnectedCallback(){this.trigger("beforeDisconnect"),this._cleanupCallbacks.forEach(e=>e()),this._cleanupCallbacks=[],this.disconnected(),this.trigger("afterDisconnect")}changed(e,t,i){}attributeChangedCallback(e,...t){return this[e+"Changed"]&&this[e+"Changed"](...t),this.trigger(e+"Changed",{detail:t}),this.changed(e,...t)}appendStyle(){if(this.constructor.style){const i=this.getRootNode();i&&i.adoptedStyleSheets&&!i.adoptedStyleSheets.find(e=>e.id==this.constructor.name)&&V(this.constructor,t=>{var e;t.hasOwnProperty("style")&&t.renderStyle&&i&&i.adoptedStyleSheets&&!i.adoptedStyleSheets.find(e=>e.id==t.name)&&(e=t.renderStyle())&&i.adoptedStyleSheets.push(t.renderStyle(e))})}}static renderStyle(){if(!this.style)return null;var e=new CSSStyleSheet;e.id=this.name;let t="";const i=e=>Array.isArray(e)?e.map(i).join("\n"):B(e)?e.call(this):e||void 0;return V(this,e=>{t+=i(e.style)}),e.replaceSync(t),e}async remove(e){return this.trigger("beforeRemove"),e&&await e(),super.remove(),this.trigger("afterRemove"),this}addEventListenerFor(...e){H(this,...e)}cleanupEventListenerFor(...e){this._cleanupCallbacks.push(()=>{e[0].removeEventListener(...e.slice(1))}),e[0].addEventListener(...e.slice(1))}trigger(...e){q(this,...e)}}class X extends t{static observer=new ResizeObserver(e=>{e.forEach(e=>e.target.resize())});static assignableAttributes={columnWidth:"max-content",method:"pop"};static assignableMethods=["initialTemplate"];connected(){this.enable()}disconnected(){this.disable()}cells(e){return Array.from(e.children).map(e=>["grid","inline-grid"].includes(getComputedStyle(e).display)?this.cells(e):e.dataset.autoGridIgnore?null:e).flat().filter(e=>null!==e)}disable(){this.constructor.observer.unobserve(this)}enable(){this.constructor.observer.observe(this)}initialTemplate(e){return e.map(e=>this.columnWidth).join(" ")}resize(){const t=getComputedStyle(this);for(var e,i=this.cells(this),r=this.initialTemplate(i).split(/(?<!\,)\s+/);this.style.setProperty("grid-template-columns",r.join(" ")),e=i.some(e=>e.offsetLeft<this.offsetLeft-parseFloat(t.paddingLeft))||i.some(e=>e.offsetLeft+e.offsetWidth>this.offsetLeft+this.offsetWidth-parseFloat(t.paddingRight)),r[this.method](),1<=r.length&&e;);}static style=`
    ...
    `}}window.customElements.define(G.tagName,G);const J=["start","end"],Z=["top","right","bottom","left"].reduce((e,t)=>e.concat(t,t+"-"+J[0],t+"-"+J[1]),[]),k=Math.min,C=Math.max,Q=Math.round,ee=Math.floor,f=e=>({x:e,y:e}),te={left:"right",right:"left",bottom:"top",top:"bottom"},ie={start:"end",end:"start"};function re(e,t,i){return C(e,k(t,i))}function z(e,t){return"function"==typeof e?e(t):e}function E(e){return e.split("-")[0]}function L(e){return e.split("-")[1]}function se(e){return"x"===e?"y":"x"}function ne(e){return"y"===e?"height":"width"}function A(e){return["top","bottom"].includes(E(e))?"y":"x"}function oe(e){return se(A(e))}function ae(e,t,i){void 0===i&&(i=!1);var r=L(e),e=oe(e),s=ne(e);let n="x"===e?r===(i?"end":"start")?"right":"left":"start"===r?"bottom":"top";return[n=t.reference[s]>t.floating[s]?he(n):n,he(n)]}function le(e){return e.replace(/start|end/g,e=>ie[e])}function ce(e,t,i,r){const s=L(e);let n=function(e,t,i){var r=["left","right"],s=["right","left"];switch(e){case"top":case"bottom":return i?t?s:r:t?r:s;case"left":case"right":return t?["top","bottom"]:["bottom","top"];default:return[]}}(E(e),"start"===i,r);return n=s&&(n=n.map(e=>e+"-"+s),t)?n.concat(n.map(le)):n}function he(e){return e.replace(/left|right|bottom|top/g,e=>te[e])}function de(e){return"number"!=typeof e?{top:0,right:0,bottom:0,left:0,...e}:{top:e,right:e,bottom:e,left:e}}function v(e){var{x:e,y:t,width:i,height:r}=e;return{width:i,height:r,top:t,left:e,right:e+i,bottom:t+r,x:e,y:t}}function ue(e,t,i){var{reference:r,floating:s}=e,e=A(t),n=oe(t),o=ne(n),a=E(t),l="y"===e,c=r.x+r.width/2-s.width/2,h=r.y+r.height/2-s.height/2,d=r[o]/2-s[o]/2;let u;switch(a){case"top":u={x:c,y:r.y-s.height};break;case"bottom":u={x:c,y:r.y+r.height};break;case"right":u={x:r.x+r.width,y:h};break;case"left":u={x:r.x-s.width,y:h};break;default:u={x:r.x,y:r.y}}switch(L(t)){case"start":u[n]-=d*(i&&l?-1:1);break;case"end":u[n]+=d*(i&&l?-1:1)}return u}async function pe(e,t){var{x:i,y:r,platform:s,rects:n,elements:o,strategy:a}=e,{boundary:t="clippingAncestors",rootBoundary:e="viewport",elementContext:l="floating",altBoundary:c=!1,padding:h=0}=z(t=void 0===t?{}:t,e),h=de(h),c=o[c?"floating"===l?"reference":"floating":l],d=v(await s.getClippingRect({element:null==(d=await(null==s.isElement?void 0:s.isElement(c)))||d?c:c.contextElement||await(null==s.getDocumentElement?void 0:s.getDocumentElement(o.floating)),boundary:t,rootBoundary:e,strategy:a})),c="floating"===l?{x:i,y:r,width:n.floating.width,height:n.floating.height}:n.reference,t=await(null==s.getOffsetParent?void 0:s.getOffsetParent(o.floating)),e=await(null==s.isElement?void 0:s.isElement(t))&&await(null==s.getScale?void 0:s.getScale(t))||{x:1,y:1},l=v(s.convertOffsetParentRelativeRectToViewportRelativeRect?await s.convertOffsetParentRelativeRectToViewportRelativeRect({elements:o,rect:c,offsetParent:t,strategy:a}):c);return{top:(d.top-l.top+h.top)/e.y,bottom:(l.bottom-d.bottom+h.bottom)/e.y,left:(d.left-l.left+h.left)/e.x,right:(l.right-d.right+h.right)/e.x}}function me(e){var t=k(...e.map(e=>e.left)),i=k(...e.map(e=>e.top));return{x:t,y:i,width:C(...e.map(e=>e.right))-t,height:C(...e.map(e=>e.bottom))-i}}function ge(){return"undefined"!=typeof window}function u(e){return fe(e)?(e.nodeName||"").toLowerCase():"#document"}function y(e){return(null==e||null==(e=e.ownerDocument)?void 0:e.defaultView)||window}function m(e){return null==(e=(fe(e)?e.ownerDocument:e.document)||window.document)?void 0:e.documentElement}function fe(e){return ge()&&(e instanceof Node||e instanceof y(e).Node)}function b(e){return!!ge()&&(e instanceof Element||e instanceof y(e).Element)}function p(e){return!!ge()&&(e instanceof HTMLElement||e instanceof y(e).HTMLElement)}function ve(e){return!(!ge()||"undefined"==typeof ShadowRoot)&&(e instanceof ShadowRoot||e instanceof y(e).ShadowRoot)}function g(e){var{overflow:e,overflowX:t,overflowY:i,display:r}=N(e);return/auto|scroll|overlay|hidden|clip/.test(e+i+t)&&!["inline","contents"].includes(r)}function ye(t){return[":popover-open",":modal"].some(e=>{try{return t.matches(e)}catch(e){return!1}})}function be(e){var t=we();const i=b(e)?N(e):e;return"none"!==i.transform||"none"!==i.perspective||!!i.containerType&&"normal"!==i.containerType||!t&&!!i.backdropFilter&&"none"!==i.backdropFilter||!t&&!!i.filter&&"none"!==i.filter||["transform","perspective","filter"].some(e=>(i.willChange||"").includes(e))||["paint","layout","strict","content"].some(e=>(i.contain||"").includes(e))}function we(){return!("undefined"==typeof CSS||!CSS.supports)&&CSS.supports("-webkit-backdrop-filter","none")}function T(e){return["html","body","#document"].includes(u(e))}function N(e){return y(e).getComputedStyle(e)}function xe(e){return b(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function R(e){return"html"!==u(e)&&(e=e.assignedSlot||e.parentNode||ve(e)&&e.host||m(e),ve(e))?e.host:e}function O(e,t,i){void 0===t&&(t=[]),void 0===i&&(i=!0);var r=function e(t){var i=R(t);return T(i)?(t.ownerDocument||t).body:p(i)&&g(i)?i:e(i)}(e),e=r===(null==(e=e.ownerDocument)?void 0:e.body),s=y(r);return e?(e=ke(s),t.concat(s,s.visualViewport||[],g(r)?r:[],e&&i?O(e):[])):t.concat(r,O(r,[],i))}function ke(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Ce(e){var t=N(e);let i=parseFloat(t.width)||0,r=parseFloat(t.height)||0;var t=p(e),s=t?e.offsetWidth:i,t=t?e.offsetHeight:r,e=Q(i)!==s||Q(r)!==t;return e&&(i=s,r=t),{width:i,height:r,$:e}}function ze(e){return b(e)?e:e.contextElement}function S(e){e=ze(e);if(!p(e))return f(1);var t=e.getBoundingClientRect(),{width:e,height:i,$:r}=Ce(e);let s=(r?Q(t.width):t.width)/e,n=(r?Q(t.height):t.height)/i;return s&&Number.isFinite(s)||(s=1),n&&Number.isFinite(n)||(n=1),{x:s,y:n}}const Ee=f(0);function Le(e){e=y(e);return we()&&e.visualViewport?{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}:Ee}function I(e,i,t,r){void 0===i&&(i=!1),void 0===t&&(t=!1);var s=e.getBoundingClientRect(),n=ze(e);let o=f(1);i&&(r?b(r)&&(o=S(r)):o=S(e));i=n,void 0===(e=t)&&(e=!1);t=!(t=r)||e&&t!==y(i)||!e?f(0):Le(n);let a=(s.left+t.x)/o.x,l=(s.top+t.y)/o.y,c=s.width/o.x,h=s.height/o.y;if(n){var i=y(n),d=r&&b(r)?y(r):r;let e=i,t=ke(e);for(;t&&r&&d!==e;){var u=S(t),p=t.getBoundingClientRect(),m=N(t),g=p.left+(t.clientLeft+parseFloat(m.paddingLeft))*u.x,p=p.top+(t.clientTop+parseFloat(m.paddingTop))*u.y;a*=u.x,l*=u.y,c*=u.x,h*=u.y,a+=g,l+=p,e=y(t),t=ke(e)}}return v({width:c,height:h,x:a,y:l})}function Ae(e,t){var i=xe(e).scrollLeft;return t?t.left+i:I(m(e)).left+i}function Te(e,t,i){void 0===i&&(i=!1);var r=e.getBoundingClientRect();return{x:r.left+t.scrollLeft-(i?0:Ae(e,r)),y:r.top+t.scrollTop}}function Ne(e,t,i){let r;var s,n,o;return v(r="viewport"===t?function(e,t){var i=y(e),e=m(e),i=i.visualViewport;let r=e.clientWidth,s=e.clientHeight,n=0,o=0;return i&&(r=i.width,s=i.height,we()&&"fixed"!==t||(n=i.offsetLeft,o=i.offsetTop)),{width:r,height:s,x:n,y:o}}(e,i):"document"===t?function(e){var t=m(e),i=xe(e),r=e.ownerDocument.body,s=C(t.scrollWidth,t.clientWidth,r.scrollWidth,r.clientWidth),n=C(t.scrollHeight,t.clientHeight,r.scrollHeight,r.clientHeight);let o=-i.scrollLeft+Ae(e);return e=-i.scrollTop,"rtl"===N(r).direction&&(o+=C(t.clientWidth,r.clientWidth)-s),{width:s,height:n,x:o,y:e}}(m(e)):b(t)?(n=(i=I(s=t,!0,"fixed"===(i=i))).top+s.clientTop,i=i.left+s.clientLeft,o=p(s)?S(s):f(1),{width:s.clientWidth*o.x,height:s.clientHeight*o.y,x:i*o.x,y:n*o.y}):(s=Le(e),{x:t.x-s.x,y:t.y-s.y,width:t.width,height:t.height}))}function Re(e,t){var i=t.get(e);if(i)return i;let r=O(e,[],!1).filter(e=>b(e)&&"body"!==u(e)),s=null;var n="fixed"===N(e).position;let o=n?R(e):e;for(;b(o)&&!T(o);){var a=N(o),l=be(o),l=(l||"fixed"!==a.position||(s=null),n?!l&&!s:!l&&"static"===a.position&&!!s&&["absolute","fixed"].includes(s.position)||g(o)&&!l&&function e(t,i){t=R(t);return!(t===i||!b(t)||T(t))&&("fixed"===N(t).position||e(t,i))}(e,o));l?r=r.filter(e=>e!==o):s=a,o=R(o)}return t.set(e,r),r}function Oe(e){return"static"===N(e).position}function Se(e,t){if(!p(e)||"fixed"===N(e).position)return null;if(t)return t(e);let i=e.offsetParent;return i=m(e)===i?i.ownerDocument.body:i}function Ie(t,e){var i,r=y(t);if(ye(t))return r;if(!p(t)){let e=R(t);for(;e&&!T(e);){if(b(e)&&!Oe(e))return e;e=R(e)}return r}let s=Se(t,e);for(;s&&(i=s,["table","td","th"].includes(u(i)))&&Oe(s);)s=Se(s,e);return(!(s&&T(s)&&Oe(s))||be(s))&&(s||function(e){let t=R(e);for(;p(t)&&!T(t);){if(be(t))return t;if(ye(t))return null;t=R(t)}return null}(t))||r}const Pe={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){var{elements:e,rect:t,offsetParent:i,strategy:r}=e,r="fixed"===r,s=m(i),e=!!e&&ye(e.floating);if(i===s||e&&r)return t;let n={scrollLeft:0,scrollTop:0},o=f(1);var e=f(0),a=p(i),l=((a||!a&&!r)&&("body"===u(i)&&!g(s)||(n=xe(i)),p(i))&&(l=I(i),o=S(i),e.x=l.x+i.clientLeft,e.y=l.y+i.clientTop),!s||a||r?f(0):Te(s,n,!0));return{width:t.width*o.x,height:t.height*o.y,x:t.x*o.x-n.scrollLeft*o.x+e.x+l.x,y:t.y*o.y-n.scrollTop*o.y+e.y+l.y}},getDocumentElement:m,getClippingRect:function(e){let{element:i,boundary:t,rootBoundary:r,strategy:s}=e;var n=(e=[..."clippingAncestors"===t?ye(i)?[]:Re(i,this._c):[].concat(t),r])[0];return{width:(e=e.reduce((e,t)=>{t=Ne(i,t,s);return e.top=C(t.top,e.top),e.right=k(t.right,e.right),e.bottom=k(t.bottom,e.bottom),e.left=C(t.left,e.left),e},Ne(i,n,s))).right-e.left,height:e.bottom-e.top,x:e.left,y:e.top}},getOffsetParent:Ie,getElementRects:async function(e){var t=this.getOffsetParent||Ie,i=await(0,this.getDimensions)(e.floating);return{reference:function(e,t,i){var r=p(t),s=m(t),e=I(e,!0,i="fixed"===i,t);let n={scrollLeft:0,scrollTop:0};var o=f(0),a=(!r&&i||("body"===u(t)&&!g(s)||(n=xe(t)),r?(a=I(t,!0,i,t),o.x=a.x+t.clientLeft,o.y=a.y+t.clientTop):s&&(o.x=Ae(s))),!s||r||i?f(0):Te(s,n));return{x:e.left+n.scrollLeft-o.x-a.x,y:e.top+n.scrollTop-o.y-a.y,width:e.width,height:e.height}}(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:i.width,height:i.height}}},getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){var{width:e,height:t}=Ce(e);return{width:e,height:t}},getScale:S,isElement:b,isRTL:function(e){return"rtl"===N(e).direction}};function De(c,t){let h=null,d;const u=m(c);function p(){var e;clearTimeout(d),null!=(e=h)&&e.disconnect(),h=null}return function i(r,s){void 0===r&&(r=!1),void 0===s&&(s=1),p();var{left:e,top:n,width:o,height:a}=c.getBoundingClientRect();if(r||t(),o&&a){r={rootMargin:-ee(n)+"px "+-ee(u.clientWidth-(e+o))+"px "+-ee(u.clientHeight-(n+a))+"px "+-ee(e)+"px",threshold:C(0,k(1,s))||1};let t=!0;try{h=new IntersectionObserver(l,{...r,root:u.ownerDocument})}catch(e){h=new IntersectionObserver(l,r)}function l(e){if((e=e[0].intersectionRatio)!==s){if(!t)return i();e?i(!1,e):d=setTimeout(()=>{i(!1,1e-7)},1e3)}t=!1}h.observe(c)}}(!0),p}function He(i,t,r,e){void 0===e&&(e={});const{ancestorScroll:s=!0,ancestorResize:n=!0,elementResize:o="function"==typeof ResizeObserver,layoutShift:a="function"==typeof IntersectionObserver,animationFrame:l=!1}=e,c=ze(i),h=s||n?[...c?O(c):[],...O(t)]:[],d=(h.forEach(e=>{s&&e.addEventListener("scroll",r,{passive:!0}),n&&e.addEventListener("resize",r)}),c&&a?De(c,r):null);let u=-1,p=null;o&&(p=new ResizeObserver(e=>{var[e]=e;e&&e.target===c&&p&&(p.unobserve(t),cancelAnimationFrame(u),u=requestAnimationFrame(()=>{var e;null!=(e=p)&&e.observe(t)})),r()}),c&&!l&&p.observe(c),p.observe(t));let m,g=l?I(i):null;return l&&function e(){const t=I(i);!g||t.x===g.x&&t.y===g.y&&t.width===g.width&&t.height===g.height||r();g=t;m=requestAnimationFrame(e)}(),r(),()=>{var e;h.forEach(e=>{s&&e.removeEventListener("scroll",r),n&&e.removeEventListener("resize",r)}),null!=d&&d(),null!=(e=p)&&e.disconnect(),p=null,l&&cancelAnimationFrame(m)}}const Me=v=>({name:"arrow",options:v,async fn(e){var{x:t,y:i,placement:r,rects:s,platform:n,elements:o,middlewareData:a}=e,{element:e,padding:l=0}=z(v,e)||{};if(null==e)return{};var l=de(l),t={x:t,y:i},i=oe(r),c=ne(i),h=await n.getDimensions(e),d="y"===i,u=d?"top":"left",p=d?"bottom":"right",d=d?"clientHeight":"clientWidth",m=s.reference[c]+s.reference[i]-t[i]-s.floating[c],g=t[i]-s.reference[i],e=await(null==n.getOffsetParent?void 0:n.getOffsetParent(e));let f=e?e[d]:0;m=m/2-g/2,g=(f=f&&await(null==n.isElement?void 0:n.isElement(e))?f:o.floating[d]||s.floating[c])/2-h[c]/2-1,n=k(l[u],g),e=k(l[p],g),o=n,d=f-h[c]-e,u=f/2-h[c]/2+m,l=re(o,u,d),p=!a.arrow&&null!=L(r)&&u!==l&&s.reference[c]/2-(u<o?n:e)-h[c]/2<0,g=p?u<o?u-o:u-d:0;return{[i]:t[i]+g,data:{[i]:l,centerOffset:u-l-g,...p&&{alignmentOffset:g}},reset:p}}}),_e=(e,t,i)=>{var r=new Map,i={platform:Pe,...i},r={...i.platform,_c:r};return(async(t,i,e)=>{var{placement:r="bottom",strategy:s="absolute",middleware:e=[],platform:n}=e,o=e.filter(Boolean),a=await(null==n.isRTL?void 0:n.isRTL(i));let l=await n.getElementRects({reference:t,floating:i,strategy:s}),{x:c,y:h}=ue(l,r,a),d=r,u={},p=0;for(let e=0;e<o.length;e++){var{name:m,fn:g}=o[e],{x:g,y:f,data:v,reset:y}=await g({x:c,y:h,initialPlacement:r,placement:d,strategy:s,middlewareData:u,rects:l,platform:n,elements:{reference:t,floating:i}});c=null!=g?g:c,h=null!=f?f:h,u={...u,[m]:{...u[m],...v}},y&&p<=50&&(p++,"object"==typeof y&&(y.placement&&(d=y.placement),y.rects&&(l=!0===y.rects?await n.getElementRects({reference:t,floating:i,strategy:s}):y.rects),{x:c,y:h}=ue(l,d,a)),e=-1)}return{x:c,y:h,placement:d,strategy:s,middlewareData:u}})(e,t,{...i,platform:r})};class s extends t{static tagName="komp-floater";static assignableAttributes={content:null,anchor:null,placement:void 0,strategy:"absolute",flip:null,offset:null,shift:!0,arrow:null,autoPlacement:!0,inline:null,autoUpdate:{},removeOnBlur:!1,container:null,timeout:0,onHide:null,onShow:null,scope:null};static bindMethods=["show","hide","checkFocus","checkEscape"];static middlewares={size:function(b){return{name:"size",options:b=void 0===b?{}:b,async fn(e){var{placement:t,rects:i,platform:r,elements:s}=e;const{apply:n=()=>{},...o}=z(b,e);var a=await pe(e,o),l=E(t),c=L(t),t="y"===A(t),{width:i,height:h}=i.floating;let d,u;"top"===l||"bottom"===l?(d=l,u=c===(await(null==r.isRTL?void 0:r.isRTL(s.floating))?"start":"end")?"left":"right"):(u=l,d="end"===c?"top":"bottom");var l=h-a.top-a.bottom,p=i-a.left-a.right,m=k(h-a[d],l),g=k(i-a[u],p),f=!e.middlewareData.shift;let v=m,y=g;null!=(m=e.middlewareData.shift)&&m.enabled.x&&(y=p),null!=(g=e.middlewareData.shift)&&g.enabled.y&&(v=l),f&&!c&&(m=C(a.left,0),p=C(a.right,0),g=C(a.top,0),l=C(a.bottom,0),t?y=i-2*(0!==m||0!==p?m+p:C(a.left,a.right)):v=h-2*(0!==g||0!==l?g+l:C(a.top,a.bottom))),await n({...e,availableWidth:y,availableHeight:v});f=await r.getDimensions(s.floating);return i!==f.width||h!==f.height?{reset:{rects:!0}}:{}}}},shift:function(m){return{name:"shift",options:m=void 0===m?{}:m,async fn(e){var{x:t,y:i,placement:r}=e;const{mainAxis:s=!0,crossAxis:n=!1,limiter:o={fn:e=>{var{x:e,y:t}=e;return{x:e,y:t}}},...a}=z(m,e);var l,c={x:t,y:i},h=await pe(e,a),r=A(E(r)),d=se(r);let u=c[d],p=c[r];s&&(c=u+h["y"===d?"top":"left"],l=u-h["y"===d?"bottom":"right"],u=re(c,u,l)),n&&(c=p+h["y"===r?"top":"left"],l=p-h["y"===r?"bottom":"right"],p=re(c,p,l));h=o.fn({...e,[d]:u,[r]:p});return{...h,data:{x:h.x-t,y:h.y-i,enabled:{[d]:s,[r]:n}}}}}},autoPlacement:function(f){return{name:"autoPlacement",options:f=void 0===f?{}:f,async fn(e){var{rects:t,middlewareData:i,placement:r,platform:s,elements:n}=e;const{crossAxis:o=!1,alignment:a,allowedPlacements:l=Z,autoAlignment:c=!0,...h}=z(f,e);var d,u,p=void 0!==a||l===Z?(u=c,p=l,((d=a||null)?[...p.filter(e=>L(e)===d),...p.filter(e=>L(e)!==d)]:p.filter(e=>E(e)===e)).filter(e=>!d||L(e)===d||!!u&&le(e)!==e)):l,e=await pe(e,h),m=(null==(m=i.autoPlacement)?void 0:m.index)||0,g=p[m];return null==g?{}:(t=ae(g,t,await(null==s.isRTL?void 0:s.isRTL(n.floating))),r!==g?{reset:{placement:p[0]}}:(s=[e[E(g)],e[t[0]],e[t[1]]],e=[...(null==(n=i.autoPlacement)?void 0:n.overflows)||[],{placement:g,overflows:s}],(t=p[m+1])?{data:{index:m+1,overflows:e},reset:{placement:t}}:(g=(null==(n=(i=e.map(e=>{var t=L(e.placement);return[e.placement,t&&o?e.overflows.slice(0,2).reduce((e,t)=>e+t,0):e.overflows[0],e.overflows]}).sort((e,t)=>e[1]-t[1])).filter(e=>e[2].slice(0,L(e[0])?2:3).every(e=>e<=0))[0])?void 0:n[0])||i[0][0])!==r?{data:{index:m+1,overflows:e},reset:{placement:g}}:{}))}}},flip:function(C){return{name:"flip",options:C=void 0===C?{}:C,async fn(e){const{placement:t,middlewareData:i,rects:r,initialPlacement:s,platform:n,elements:o}=e,{mainAxis:a=!0,crossAxis:l=!0,fallbackPlacements:c,fallbackStrategy:h="bestFit",fallbackAxisSideDirection:d="none",flipAlignment:u=!0,...p}=z(C,e);if(null==(m=i.arrow)||!m.alignmentOffset){var m=E(t);const x=A(s);var g=E(s)===s,f=await(null==n.isRTL?void 0:n.isRTL(o.floating)),g=c||(g||!u?[he(s)]:(v=he(g=s),[le(g),v,le(v)]));const k="none"!==d;!c&&k&&g.push(...ce(s,u,d,f));var v=[s,...g],g=await pe(e,p),e=[],y=(null==(b=i.flip)?void 0:b.overflows)||[];if(a&&e.push(g[m]),l&&(b=ae(t,r,f),e.push(g[b[0]],g[b[1]])),y=[...y,{placement:t,overflows:e}],!e.every(e=>e<=0)){var b,w,f=((null==(m=i.flip)?void 0:m.index)||0)+1,g=v[f];if(g)return{data:{index:f,overflows:y},reset:{placement:g}};let e=null==(b=y.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0])?void 0:b.placement;if(!e)switch(h){case"bestFit":{const t=null==(w=y.filter(e=>{return!k||(e=A(e.placement))===x||"y"===e}).map(e=>[e.placement,e.overflows.filter(e=>0<e).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0])?void 0:w[0];t&&(e=t);break}case"initialPlacement":e=s}if(t!==e)return{reset:{placement:e}}}}return{}}}},inline:function(o){return{name:"inline",options:o=void 0===o?{}:o,async fn(e){const{placement:c,elements:t,rects:i,platform:r,strategy:s}=e,{padding:n=2,x:h,y:d}=z(o,e);e=Array.from(await(null==r.getClientRects?void 0:r.getClientRects(t.reference))||[]);const u=function(e){var t=e.slice().sort((e,t)=>e.y-t.y),i=[];let r=null;for(let e=0;e<t.length;e++){var s=t[e];!r||s.y-r.y>r.height/2?i.push([s]):i[i.length-1].push(s),r=s}return i.map(e=>v(me(e)))}(e),p=v(me(e)),m=de(n);e=await r.getElementRects({reference:{getBoundingClientRect:function(){if(2===u.length&&u[0].left>u[1].right&&null!=h&&null!=d)return u.find(e=>h>e.left-m.left&&h<e.right+m.right&&d>e.top-m.top&&d<e.bottom+m.bottom)||p;if(2<=u.length){var e,t;if("y"===A(c))return i=u[0],r=u[u.length-1],s="top"===E(c),{top:e=i.top,bottom:n=r.bottom,left:t=(s?i:r).left,right:s=(s?i:r).right,width:s-t,height:n-e,x:t,y:e};const o="left"===E(c),a=C(...u.map(e=>e.right)),l=k(...u.map(e=>e.left));var i=u.filter(e=>o?e.left===l:e.right===a),r=i[0].top,s=i[i.length-1].bottom,n=l;return{top:r,bottom:s,left:n,right:a,width:a-n,height:s-r,x:n,y:r}}return p}},floating:t.floating,strategy:s});return i.reference.x!==e.reference.x||i.reference.y!==e.reference.y||i.reference.width!==e.reference.width||i.reference.height!==e.reference.height?{reset:{rects:e}}:{}}}},arrow:Me,offset:function(o){return{name:"offset",options:o=void 0===o?0:o,async fn(e){var t,{x:i,y:r,placement:s,middlewareData:n}=e,e=await async function(e,t){var{placement:i,platform:r,elements:s}=e,r=await(null==r.isRTL?void 0:r.isRTL(s.floating)),s=E(i),n=L(i),i="y"===A(i),s=["left","top"].includes(s)?-1:1,r=r&&i?-1:1;let{mainAxis:o,crossAxis:a,alignmentAxis:l}="number"==typeof(t=z(t,e))?{mainAxis:t,crossAxis:0,alignmentAxis:null}:{mainAxis:t.mainAxis||0,crossAxis:t.crossAxis||0,alignmentAxis:t.alignmentAxis};return n&&"number"==typeof l&&(a="end"===n?-1*l:l),i?{x:a*r,y:o*s}:{x:o*s,y:a*r}}(e,o);return s===(null==(t=n.offset)?void 0:t.placement)&&null!=(t=n.arrow)&&t.alignmentOffset?{}:{x:i+e.x,y:r+e.y,data:{...e,placement:s}}}}}};showing=!1;initialize(){if(super.initialize(),"string"==typeof this.anchor)this.anchor=this.getRootNode().querySelector(this.anchor);else if(!(this.anchor instanceof Element)){const e=this.anchor;this.anchor={getBoundingClientRect(){return{width:0,height:0,x:e.x,y:e.y,left:e.x,right:e.x,top:e.y,bottom:e.y}}}}this.middleware=[],Object.keys(this.constructor.middlewares).forEach(e=>{this[e]&&("arrow"==e?(this.classList.add("komp-floater-arrow"),this.middleware.push(Me({element:this.initializeArrow()}))):this.middleware.push(this.constructor.middlewares[e](!0===this[e]?{}:this[e])))})}connected(){if(this.style.position=this.strategy,!this.anchor)throw"Floater needs anchor to position to.";this._cleanupCallbacks.push(He(this.anchor,this,this.updatePosition.bind(this),this.autoUpdate)),this.classList.add("-in"),this.addEventListener("animationend",()=>{this.classList.remove("-in")},{once:!0}),this.removeOnBlur&&(this.cleanupEventListenerFor(this.getRootNode().body,"focusin",this.checkFocus),this.cleanupEventListenerFor(this.getRootNode().body,"click",this.checkFocus),this.cleanupEventListenerFor(this.getRootNode().body,"keyup",this.checkEscape))}initializeArrow(){var e;return this.querySelector("komp-floater-arrow-locator")?this.querySelector("komp-floater-arrow-locator"):(e=w("komp-floater-arrow-locator"),this.prepend(e),"number"==typeof this.arrow&&this.style.setProperty("--arrow-size",this.arrow+"px"),this.offset||(this.offset=!0===this.arrow?10:this.arrow),"none"!=h(this,"box-shadow")&&(this.style.filter=h(this,"box-shadow").split(/(?<!\([^\)]*),/).map(e=>`drop-shadow(${e.trim().split(/(?<!\([^\)]*)\s/).slice(0,4).join(" ")})`).join(" "),this.style.boxShadow="none"),e)}updatePosition(){_e(this.anchor,this,{strategy:this.strategy,placement:this.placement,middleware:this.middleware}).then(this.computePosition.bind(this))}computePosition({x:e,y:t,placement:i,middlewareData:r}){if(this.style.left=e+"px",this.style.top=t+"px",this.classList.remove("-top","-left","-bottom","-right"),this.classList.add("-"+i.split("-")[0]),r.arrow){const{x:e,y:t}=r.arrow;null!=e&&(this.style.setProperty("--arrow-left",e+"px"),this.querySelector("komp-floater-arrow-locator").style.setProperty("left",e+"px")),null!=t&&(this.style.setProperty("--arrow-top",t+"px"),this.querySelector("komp-floater-arrow-locator").style.setProperty("top",e+"px"))}}checkFocus(e){e.defaultPrevented||e.target==this||e.target==this.anchor||this.contains(e.target)||this.anchor.contains&&this.anchor.contains(e.target)||this.hide()}checkEscape(e){27==e.which&&this.hide()}remove(){return new Promise(e=>{this.classList.add("-out");var t=()=>{this.classList.remove("-out"),super.remove().then(e)};"none"!=h(this,"animation-name")?this.addEventListener("animationend",t,{once:!0}):t()})}show(){if(this._hideTimeout&&(clearTimeout(this._hideTimeout),delete this._hideTimeout),this._removing)return this._removing.then(this.show);if("string"==typeof this.container&&(this.container=this.closest(this.container)||this.anchor.closest&&this.anchor.closest(this.container)),null==this.container&&(this.container=this.parentElement||this.anchor.parentElement),!this.parentElement){if(this.showing=!0,this.onShow&&0==this.onShow())return;this.scope&&(window.activeTooltips||(window.activeTooltips={}),window.activeTooltips[this.scope]&&window.activeTooltips[this.scope]!=this&&window.activeTooltips[this.scope].hideNow(),window.activeTooltips[this.scope]=this),this.container.append(this),this.trigger("shown")}return this}hideNow(){this.hideAfterTimeout()}hide(){if(!this._hideTimeout&&!this._hiding)return new Promise(e=>{this._hideTimeout=setTimeout(()=>{this.hideAfterTimeout(),e()},this.timeout)})}hideAfterTimeout(){return this.parentElement?this._removing=this.remove().then(()=>{this.showing=!1,this.trigger("hidden"),this.onHide&&this.onHide(),delete this._hideTimeout,delete this._removing}):this}toggle(e){return this[(e="boolean"!=typeof e?null!==this.offsetParent:e)?"hide":"show"](),this}static style=`
        .komp-floater-arrow {
            --arrow-size: 0.5em;
            --arrow-left: 0;
            --arrow-top: 0;
    ...
    `}window.customElements.define(it.tagName,it);class r extends i{static tagName="komp-spreadsheet-cell";static assignableAttributes={readonly:!1};constructor(e,...t){super(e,...t),this.tabIndex=0,this.addEventListener("focusin",this.onFocusIn),this.addEventListener("focusout",this.onFocusOut),null!=e.disabled&&this.toggleAttribute("disabled",e.disabled)}onFocusIn(e){this.focusCell=w(this.table.tagName+"-focus"),this.focusCell.classList.toggle("frozen",this.classList.contains("frozen")),this.focusCell.classList.toggle("readonly",this.readonly),this.focusCell.style.setProperty("grid-column",this.cellIndex),this.groupIndex&&this.focusCell.style.setProperty("grid-row",this.groupIndex),this.parentElement.append(this.focusCell);var t=parseInt(h(this.focusCell,"outline-width"));const i=this.table.scrollLeft+this.table.frozenLeft,r=this.table.scrollTop+this.table.header.offsetHeight,s=this.table.scrollLeft+this.table.clientWidth,n=this.table.scrollTop+this.table.clientHeight,o=this.focusCell.offsetLeft-t,a=this.focusCell.offsetTop-t,l=this.focusCell.offsetLeft+this.focusCell.offsetWidth+t,c=this.focusCell.offsetTop+this.focusCell.offsetHeight+t;t={left:0,top:0};o<i?t.left=o-i:l>s&&(t.left=l-s),a<r?t.top=a-r:c>n&&(t.top=c-n),this.table.scrollBy(t)}onFocusOut(e){this.focusCell.remove(),delete this.focusCell}focusAdjacentCell(e){let t=this.cellIndex,i=this.rowIndex,r=this.groupIndex;"up"==e||"down"==e?i+="up"==e?-1:1:t+="left"==e?-1:1,r&&("up"==e?1==r?r=-1:(r--,i=this.rowIndex):"down"==e&&(r==this.parentElement.rowCount?r=1:(r++,i=this.rowIndex)));var s,n=this.table.at(t,i,r);return n&&(this.table.style.setProperty("scroll-snap-type","unset"),s=n.getBoundingClientRect(),this.table.getBoundingClientRect(),e=["left","up"].includes(e)?[s.x+1,s.y+1]:[s.x+s.width-1,s.y+s.height-1],document.elementFromPoint(...e),n.focus({preventScroll:!0}),this.table.style.removeProperty("scroll-snap-type")),n}async activate(e={}){if(!this.readonly&&void 0!==this.spawnInput&&null!==this.spawnInput){const t=await this.spawnInput(e);if(void 0!==t&&null!==t&&!1!==t){this.tabIndex=-1,t.addEventListener("hidden",()=>{this.tabIndex=0,this.render()});let e=t.querySelector("[autofocus]");if(e=e||t.querySelector("input, textarea, select, [contenteditable]")){const i=()=>{e.focus(),e.showPicker&&e.showPicker()};e._loading&&e._loading instanceof Promise?e._loading.then(()=>setTimeout(i,50)):setTimeout(i,50)}return t.addEventListener("keyup",e=>{"Escape"==e.key?(t.setAttribute("preventChange",!0),this.focus(),e.preventDefault()):"Enter"==e.key&&!1!==this.column.onEnter(e)&&!this.table._enterDown&&[e.metaKey,e.ctrlKey,e.altKey,e.shiftKey].every(e=>0==e)&&(e.preventDefault(),this.focusAdjacentCell("down")||(this.focus(),t.hide()))}),t.addEventListener("keydown",e=>{"Enter"==e.key&&!1!==this.column.onEnter(e)&&[e.metaKey,e.ctrlKey,e.altKey,e.shiftKey].every(e=>0==e)&&e.preventDefault()}),t}}}createInput(e){return this.column.input(this.record,this,e)}async spawnInput(e){var e=await this.createInput(e);return e&&(c(this,e=new s({class:"komp-spreadsheet-input",anchor:this,style:{"--padding":h(this,"padding"),"--cell-width":this.offsetWidth+"px","--cell-height":this.offsetHeight+"px","--remaining-width":this.table.offsetWidth-this.offsetLeft+"px","--remaining-height":this.table.offsetHeight-this.offsetTop+"px"},content:{tag:"label",content:e,class:this.column.class},placement:"bottom-start",autoPlacement:{alignment:"start",allowedPlacements:["top","bottom"]},removeOnBlur:!0,offset:({rects:e})=>({mainAxis:-e.reference.height})})),e.show())}canCopy(){return!!this.column.copy}copy(){return this.column.copy(this)}canPaste(){return!!this.column.paste}paste(e){return this.column.paste(this,e)}clear(){this.column.clear(this),this.render()}contextMenu(e){return this.column?.contextMenu(e,this,this.column)}}window.customElements.define(r.tagName,r);class rt extends r{static tagName="komp-spreadsheet-header-cell";render(){return o(this,n(this.column,"header",this)),this}createInput(){if(this.column.headerEditable)return P.create("contentarea",Object.assign({record:this.column,attribute:"header"}))}canCopy(){return!0}copy(){return n(this.column,"header",this)}canPaste(){return!0}paste(e){return this.column.header=e}connected(){super.connected(),this.column.frozen&&this.table.observeResize(this)}disconnected(){this.column.frozen&&this.table.unobserveResize(this)}}window.customElements.define(rt.tagName,rt);class st extends Ye{static Cell=r;static HeaderCell=rt;static assignableAttributes={type:null,attribute:null,headerEditable:!0};static assignableMethods=["input","copy","paste"];initialize(e){this.configuredContextMenu=e.contextMenu,this.inputOptions=e.input,e.hasOwnProperty("copy")&&!e.copy&&(this.copy=void 0),e.hasOwnProperty("paste")&&!e.paste&&(this.paste=void 0)}headerFallback(){return this.attribute}render(e){e=n(e,this.attribute);return e&&"string"==typeof e?e.replaceAll("\n","<br>"):e}copy(e){return n(e.record,this.attribute)}static pasteAccepts=["text/plain"];paste(e,t){e.record[this.attribute]=t}clear(e){e.record[this.attribute]=null}input(e,t,i){return P.create(this.type||"contentarea",Object.assign({record:e,attribute:this.attribute,autofocus:!0},this.inputOptions,i))}contextMenu(e,...t){return this.configuredContextMenu?this.configuredContextMenu(e,...t):e}onEnter(){}}class nt extends st{paste=void 0;renderCell(e,t={}){return t.readonly=!0,super.renderCell(e,t)}}class ot extends st{static assignableAttributes={type:"number"};async paste(e,t){var i=parseFloat(t);return isNaN(i)?super.paste(e,t):super.paste(e,i)}}class at extends st{static assignableAttributes={type:"checkbox"};input(e,t){t=t.querySelector("input");t.checked=!t.checked,q(t,"change")}render(e){return w("label",{content:P.create(this.type,Object.assign({record:e,attribute:this.attribute,name:this.attribute},this.inputOptions))})}paste(e,t){return super.paste(e,!!t)}}class lt extends st{static inputAttributes=["options"];static assignableAttributes={type:"select"};constructor(e){super(e),this.options=e.options}async input(e){return P.create(this.type,Object.assign({record:e,attribute:this.attribute,options:this.options,autofocus:!0},this.inputOptions))}}function ct(e){e.cellsDimensions=function(e){var t=this.querySelectorAll(this.cellSelector),t=t.item(t.length-1);return{width:t.offsetLeft+t.offsetWidth,height:t.offsetTop+t.offsetHeight}[e]}}function ht(e){this.include(ct),this.events.push("columnResize","rowResize"),this.assignableAttributes.resize=!0,this.assignableAttributes.resizeMin=5;const t=e.initialize,i=(e.initialize=function(...e){return!0===this.resize?this.resize=["columns","rows"]:!1===this.resize?this.resize=[]:"string"==typeof this.resize&&(this.resize=[this.resize]),this.addEventListenerFor(this.cellSelector,"mouseover",()=>{this.clearResizeHandles()}),this.addEventListener("mouseleave",()=>{this.clearResizeHandles()}),this.addEventListenerFor(".resizable","mouseover",e=>{this.showResizeHandleFor(e.delegateTarget)}),t.call(this,...e)},this.columnTypeRegistry.default.assignableAttributes.resize=!0,e.renderColumnHeader);e.renderColumnHeader=function(e,...t){t=i.call(this,e,...t);return this.resize.includes("columns")&&0!=e.resize&&t.classList.add("resizable","resizable-column"),t},e.clearResizeHandles=function(){this.resizing||this.querySelectorAll(this.tagName+"-resize-handle").forEach(e=>e.remove())},e.showResizeHandleFor=function(r){this.resizing||(this.clearResizeHandles(),["column","row"].forEach(e=>{var t,i;r.classList.contains("resizable-"+e)&&(t=d(this.tagName+"-resize-handle",{class:"resizable-"+e,content:[{tag:"handle-start"},{tag:"handle-end"}],style:{"grid-column":r.cellIndex,"grid-row":r.rowIndex}},"pointerdown",this.activateAxisResize.bind(this)),r.classList.contains("frozen")&&t.classList.add("frozen","frozen-"+r.cellIndex),(i="column"==e?r:r.row).previousElementSibling&&i.previousElementSibling.classList.contains("resizable-"+e)||t.querySelector("handle-start").remove(),t.cell=r,this.append(t))}))},e.activateAxisResize=function(e){this.setPointerCapture(e.pointerId),this.resizing=!0;var t=e.target.parentElement,i=this.getBoundingClientRect();let r=t.cell,{direction:s,axis:n,axisMin:o,axisMax:a,offset:l,slice:c,start:h,blockDimension:d,inlineDimension:u,sliceType:p,sliceIndex:m}=("handle-start"==e.target.localName&&(r=t.classList.contains("resizable-row")?this.at(r.cellIndex,r.rowIndex-1):r.previousElementSibling),t.classList.contains("resizable-row")?{direction:"Row",axis:"y",axisMin:r.offsetTop+this.resizeMin,axisMax:this.scrollHeight,offset:this.scrollTop-i.top,slice:r.row,start:e.y-r.offsetHeight,blockDimension:"width",inlineDimension:"height",inlinePosition:"Top",index:"rowIndex",sliceIndex:"rowIndex",sliceType:"rows"}:{direction:"Column",axis:"x",axisMin:r.offsetLeft+this.resizeMin,axisMax:this.scrollWidth,offset:this.scrollLeft-i.left,slice:r.column,start:e.x-r.offsetWidth,blockDimension:"height",inlineDimension:"Width",inlinePosition:"Left",index:"cellIndex",sliceIndex:"index",sliceType:"columns"});this.classList.add("resizing-"+s.toLowerCase());t=Array.from(this.querySelectorAll(this.constructor.Header.tagName+" > .selected"));let g;g=t.includes(r)?x(t.map(e=>"Column"==s?e.column:e.row)):(this.clearSelectedCells&&this.clearSelectedCells(),this.selectCells&&this.selectCells(r),[c]),this.clearOutlines&&this.clearOutlines();const f=w(this.constructor.tagName+"-drag-indicator",{class:s.toLowerCase(),style:{"inset-inline-start":e[n]+l+"px","block-size":this.cellsDimensions(d)+"px"}});function v(e){e=e[n]+l,e=Math.max(e,o);e=Math.min(e,a),f.style.insetInlineStart=e+"px"}this.append(f),this.addEventListener("pointermove",v),this.addEventListener("pointerup",e=>{let t=e[n]-h;t=Math.max(t,this.resizeMin);const i=Math.min(...g.map(e=>e[m]));this[p].filter(e=>e[m]<i).forEach(e=>{e[u.toLowerCase()]=e.cells.values().toArray().at(0)["offset"+u]+"px"}),g.forEach(e=>{e[u.toLowerCase()]=t+"px"}),this.trigger(s.toLowerCase()+"Resize",{detail:{[p]:g}}),f.remove(),this.removeEventListener("pointermove",v),setTimeout(()=>{this.resizing=!1,this.classList.remove("resizing-"+s.toLowerCase()),this.releasePointerCapture(e.pointerId)})},{once:!0})},Array.isArray(this.style)||(this.style=[this.style]),this.style.push(()=>`
        ${this.tagName} {
            --select-color: #1a73e8;
            --handle-size: 10px;
        }
    ...
    `,style:{"grid-column":t.cellIndex,"grid-row":t.rowIndex}},"pointerdown",this.activateAxisReorder.bind(this)),t.classList.contains("frozen")&&e.classList.add("frozen","frozen-"+t.cellIndex),e.cell=t,this.append(e))}))},e.activateAxisReorder=function(e){this.setPointerCapture(e.pointerId);const r=this.getRootNode(),s=(this.reordering=!0,this.classList.add("reordering"),e.currentTarget);e=s.cell;const n=this.getBoundingClientRect();let{slice:t,direction:o,index:a,sliceIndex:l,axis:c,inlinePosition:h,inlineDimension:d,blockDimension:i}=s.classList.contains("reorderable-row")?{slice:e.row,direction:"Row",index:"rowIndex",sliceIndex:"rowIndex",inverseDirection:"Column",axis:"y",inlinePosition:"Top",inlineDimension:"Height",blockDimension:"Width"}:{slice:e.column,direction:"Column",index:"cellIndex",sliceIndex:"index",inverseDirection:"Row",axis:"x",inlinePosition:"Left",inlineDimension:"Width",blockDimension:"Height"},u,p;if((p=this.selectedCells?Array.from(this.querySelectorAll(this.constructor.Header.tagName+" > .selected")):p)&&p.includes(e)){let i=(u=x(p.map(e=>"Column"==o?e.column:e.row)))[0];u=u.filter((e,t)=>e[l]-i[l]<=1&&(i=e,!0))}else u=[t];this.clearSelectedCells&&this.clearSelectedCells(),u.forEach(e=>e.cells.forEach(e=>{e.classList.add("selected"),e.cells.forEach(e=>e.classList.add("selected"))})),this.selectedCells&&this.outlineCells(this.selectedCells());const m=Math.min(...u.map(e=>e[l])),g=(s.style.inlineSize=u.map(e=>e["offset"+d]).reduce((e,t)=>e+t)+"px",s.style.blockSize=this.cellsDimensions(i.toLowerCase())+"px",s.style.insetInlineStart=s["offset"+h]+"px",s.style.removeProperty("grid-area"),s.classList.add("reordering"),w(this.constructor.tagName+"-placement-indicator",{class:o.toLowerCase(),style:{["grid-"+o.toLowerCase()]:m}})),f=(g[a]=m,this.append(g),this.cellSelector.split(", ").map(e=>e+(".reorderable-"+o.toLowerCase())));let v,y=!1;const b=e=>{var t=r.elementsFromPoint(e.x,e.y).find(e=>e.matches(f.join(",")))||v,e=(v=t,e[c]-n[h.toLowerCase()]-s["offset"+d]/2+this["scroll"+h]);if(e=(e=e<0?0:e)>this["scroll"+d]-s["offset"+d]?this["scroll"+d]-s["offset"+d]:e,s.style.insetInlineStart=e+"px",t){e=t[a]+(m<t[a]?1:0);if(g[a]!=e){if(y)return;let e=this["scroll"+h];!s.cell.frozen&&this.frozenLeft&&"Column"==o&&(e+=this.frozenLeft),e+=.05*this["client"+d];var i=this["scroll"+h]+.95*this["client"+d];t["offset"+h]+t["offset"+d]>i?(y=!0,this.scrollBy({[h.toLowerCase()]:t["offset"+d]})):t["offset"+h]<e&&(y=!0,this.scrollBy({[h.toLowerCase()]:-1*t["offset"+d]})),y&&setTimeout(()=>y=!1,100)}g[a]=e,g.style["grid-"+o.toLowerCase()]=e}};this.addEventListener("pointermove",b),this.addEventListener("pointerup",async e=>{var t;g[a]!=m&&(t=g[a]-(m<g[a]?u.length:0),"Column"==o?(this.columns.splice(m-1,u.length),await this.insertColumns(t,...u)):(u.forEach(e=>e.remove()),await this.appendRow(t,...u)),this.trigger(o.toLowerCase()+"Reorder",{detail:{fromIndex:m-1,toIndex:t-1}})),this.selectedCells&&(this.clearOutlines(),this.outlineCells(this.selectedCells())),g.remove(),this.removeEventListener("pointermove",b),setTimeout(()=>{this.classList.remove("reordering"),this.reordering=!1,this.showReorderHandleFor(s.cell),this.releasePointerCapture(e.pointerId)})},{once:!0})},Array.isArray(this.style)||(this.style=[this.style]),this.style.push(()=>`
        ${this.tagName} {
            --select-color: #1a73e8;
            --handle-size: 10px;
            user-select: none;
    ...
    `)}},document.addEventListener("DOMContentLoaded",function(){H(document,".js-toggle-source","click",e=>{document.querySelector(e.delegateTarget.getAttribute("rel")).classList.toggle("hide")})})}();