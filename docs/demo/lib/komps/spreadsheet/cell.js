...
/**
 * The cell for {@link Spreadsheet}
 *
 * @class SpreadsheetCell
 * @extends TableCell
 *
 * @param {Object} [options={}]
 * @param {boolean} [options.readonly=false] - make the cell present, but inactive (won't generate input)
 *
    ...
    async activate (options={}) {
        ...
        inputFloater.addEventListener('keyup', e => {
            if (e.key == "Escape") {
                ...
                this.focus()
                e.preventDefault()
            } else if (e.key == "Enter" && this.column.onEnter(e) !== false && !this.table._enterDown && [e.metaKey,e.ctrlKey,e.altKey,e.shiftKey].every(x => x == false)) {
                e.preventDefault()
        ...
        inputFloater.addEventListener('keydown', e => {
            if (e.key == "Enter" && this.column.onEnter(e) !== false && [e.metaKey,e.ctrlKey,e.altKey,e.shiftKey].every(x => x == false)) {
                e.preventDefault()
            }
        })
        return inputFloater
