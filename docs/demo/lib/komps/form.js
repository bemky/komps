 ...
 * @param {function} [options.beforeSubmit] - called before submit with `target`. Return `false` to cancel.
 * @param {function} [options.afterSubmit] - called after successful submit with `target`
 *
