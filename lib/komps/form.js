 ...
 * @param {function} [options.onSubmit] - event listener for submit (fires before saving). Call `event.preventDefault()` to prevent `target.save()` and the `submitted` event from firing.
...
export default class Form {
    ...
    constructor (target, options = {}) {
        ...
        // Append this classes submit listener last so that it can be canceled
