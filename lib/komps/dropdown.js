 ...
 * |---|---|---|---|
 * | `show` | none | `this` | Shows the dropdown and adds the `-active` class to the anchor element |
 * | `hide` | none | `this` | Hides the dropdown and removes the `-active` class from the anchor element |
 * | `toggle` | `[shouldHide:boolean]` | `this` | Toggles the dropdown visibility. If shouldHide is provided, will explicitly show or hide |
 *
