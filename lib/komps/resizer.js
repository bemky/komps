 ...
 * @param {boolean} [options.handles.autohide=false] - fade edge handles until hovered
...
export default class Resizer extends KompElement {
    ...
    /**
     * Returns bounding constraints for resize/move operations.
     * Override via constructor option to provide custom bounds.
     * @returns {Object} bounds with optional `top`, `right`, `bottom`, `left` properties
     */
    bounds () {
        return {}
    }
