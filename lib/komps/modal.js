...
Example
----
<div class="pad-2x text-purple">
    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
    <div class="flex justify-content-center pad-v-2x">
        <button type="button" class="uniformButton -xl -purple" onClick="document.body.append(new Modal({content: document.getElementById('modal-1').innerHTML, class: 'bg-white pad width-300-px'}))">
            Show Modal
        </button>
    </div>
...
<div id="modal-1" class="hide">
    ...
    <div class="flex justify-content-center pad-v-2x">
        <button type="button" class="uniformButton -xl -purple" onClick="document.body.append(new Modal({content: document.getElementById('modal-2').innerHTML, class: 'bg-white pad width-300-px'}))">
            Show Another Modal
        </button>
    </div>
    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
