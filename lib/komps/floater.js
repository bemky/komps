...
export default class Floater extends KompElement {
    ...
    connected () {
        ...
        if (this.removeOnBlur) {
            this.manageEventListenerFor(this.getRootNode().body, 'focusin', this.checkFocus)
            this.manageEventListenerFor(this.getRootNode().body, 'click', this.checkFocus)
            this.manageEventListenerFor(this.getRootNode().body, 'keyup', this.checkEscape)
        }
    }
