...
export default class Tooltip extends Floater {
    ...
    connected () {
        ...
        // Show on focus, hide on blur, Escape to dismiss
        if (this.anchor instanceof HTMLElement) {
            this.cleanupEventListenerFor(this.anchor, 'focus', () => {
                this.show()
            })
            this.cleanupEventListenerFor(this.anchor, 'blur', () => {
                this.hide()
            })
            this.cleanupEventListenerFor(this.anchor, 'keydown', e => {
