/**
 * The cell element for a {@link Spreadsheet}. A focusable identity/styling shell
 * over {@link DataGridCell}: selection painting, editing, and keyboard navigation are
 * all driven by the {@link Spreadsheet} controller against the row/column model
 ...
 * binding rather than the selection (see {@link SpreadsheetCell#bind}).
 *
...
export default class SpreadsheetCell extends DataGridCell {
