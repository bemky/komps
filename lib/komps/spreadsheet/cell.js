...
export default class SpreadsheetCell extends TableCell {
    ...
    async activate (options={}) {
        ...
        inputCell.addEventListener('focusout', e => {
            console.log(!inputCell.contains(e.relatedTarget) && !inputCell.clickedInside, inputCell.contains(e.relatedTarget), inputCell.clickedInside);
    ...
    async paste (v) {
        await this.column.paste(this, v)
        this.render()
    }
