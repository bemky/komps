 ...
 * |---|---|---|---|
 * | `renderResult` | `result:Any` | `string\|HTMLElement` | renders a single result item as a button |
 * | `renderResults` | `results:Array` | `Array` | renders the full results list, including empty state |
 *
 * ## Events
 *
 * | Event | Arguments | Description |
 * |---|---|---|
 * | `select` | `result, query, event` | fired when a result is selected |
 * | `search` | `query` | fired when a search is performed |
 * | `results` | `results, query` | fired when results are rendered |
 *
