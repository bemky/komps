...
export default class KompElement extends HTMLElement {
            ...
            Object.defineProperty(this, attribute, {
                ...
                set: (value) => {
                    ...
                    if (value !== was) {
                        ...
                        // Was causing recursion, not sure why it was there
                        // if (typeof this[attribute] == 'function') {
                        //     const funcWas = this[attribute]
                        //     this._attributes[attribute] = function (...args) {
                        //         funcWas.call(this, ...args)
    ...
    appendStyle () {
        if (this.constructor.hasOwnProperty('style')) {;
    ...
    static renderStyle () {
        ...
        eachPrototype(this, proto => {
            if (isFunction(proto.style)) {
                body += proto.style.call(this)
            } else if (!!proto.style) {
                body += proto.style
            }
        })
