...
export default class KompElement extends HTMLElement {
    ...
    /**
     * Set to `true` in subclasses to opt in to native form association via
     * the {@link https://developer.mozilla.org/en-US/docs/Web/API/ElementInternals ElementInternals} API.
     *
     * @type {boolean}
     * @static
     * @default false
    ...
    // -- ElementInternals form-association helpers --
