...
export default class KompElement extends HTMLElement {
    ...
    /**
     * Components used internally by this component. Called recursively by {@link KompElement.define define()}.
     * @type {Array<typeof KompElement>}
     * @static
     */
    static composes = []

    /**
     * Register this component and all components it {@link KompElement.composes composes} as custom elements. Safe to call multiple times.
    ...
    static define(tagName) {
        ...
        for (const Component of this.composes) {
            Component.define()
        }
    }
    /**
