...
export default class Table extends KompElement {
    ...
    async initializeColumns () {
        ...
        if (frozenColumns.length > 0) {
            this.append(this.observeIntersection(createElement('komp-spreadsheet-frozen-indicator', {
                class: 'column',
                data: {
                    target: 'komp-spreadsheet-frozen-divider.column'
                }
            })))
            this.append(createElement('komp-spreadsheet-frozen-divider', {
                class: 'column',
                style: {
    ...
    renderHeader () {
        ...
        this.append(this.observeIntersection(createElement('komp-spreadsheet-frozen-indicator', {
            class: 'row',
            data: {
                target: 'komp-spreadsheet-frozen-divider.row'
            }
        })))
        this.append(createElement('komp-spreadsheet-frozen-divider', {
            class: 'row',
