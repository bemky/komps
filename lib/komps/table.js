...
export default class Table extends KompElement {
    ...
    async render () {
        ...
        await append(fragment, await this.renderRows())
    ...
    renderHeader (container) {
        ...
        container.append(this.observeIntersection(createElement(`${this.localName}-frozen-indicator`, {
            class: 'row',
            data: {
                target: `${this.localName}-frozen-divider.row`
            }
        })))
        container.append(createElement(`${this.localName}-frozen-divider`, {
            class: 'row',
            style: {
                'grid-row': '1'
            }
