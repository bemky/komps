...
export default function (proto) {
    ...
    const _columnInitialize = this.columnTypeRegistry.default.prototype.initialize
    this.columnTypeRegistry.default.prototype.initialize = function (...args) {
        this.toggles = new Set()
        return _columnInitialize.call(this, ...args)
    }
