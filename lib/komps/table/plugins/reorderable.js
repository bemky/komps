/**
 * A plugin to make {@link Table}'s columns and rows reorderable
 *
 * @function Plugin/Reorderable
 * @mixin
 *
...
export default function (proto) {
    ...
    this.columnTypeRegistry.default.assignableAttributes.reorder = { type: 'boolean', default: true, null: false }
