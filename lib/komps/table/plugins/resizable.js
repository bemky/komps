...
export default function (proto) {
    ...
    proto.activateAxisResize = function (e) {
        ...
        let { direction, axis, axisMin, axisMax, offset, slice, start, blockDimension, inlineDimension, index } = handle.classList.contains('resizable-row') ? {
            direction: 'Row',
            axis: 'y',
            axisMin: target.offsetTop,
