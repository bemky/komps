...
export default class Spreadsheet extends Table {
    ...
    outlineCells (cells) {
        ...
        // There's a reason this was here, but not sure why, removed because it was causing weirdness with selecting splitCellIndex with introduction of collapsible - BE
    ...
    static style = `
        ...
        komp-table-row > komp-spreadsheet-cell.selected::after,
        komp-table-row > komp-spreadsheet-cell:has(.selected)::after,
        komp-table-row > komp-spreadsheet-cell.selecting::after,
        komp-table-row > komp-spreadsheet-cell:has(.selecting)::after {
            content: '';
            position: absolute;
            inset: 0;
