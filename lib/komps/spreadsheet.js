...
export default class Spreadsheet extends DataGrid {
    ...
    instantiate (...args) {
        ...
        this.addEventListenerFor(`${this.tagName}-cell`, 'mouseover', this.clearResizeHandles.bind(this))
        this.addEventListener('mouseleave', this.clearResizeHandles.bind(this))
    ...
    renderCell (item, column, index) {
        const cell = super.renderCell(item, column, index)
        if (column.frozen) {
    ...
    */
    ...
    activateAxisResize (e) {
        ...
        let { direction, axis, offset, index, start } = handle.classList.contains('resizable-row') ? {
            ...
            index: target.parentElement.row,
