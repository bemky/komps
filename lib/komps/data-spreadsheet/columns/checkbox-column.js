...
export default class CheckboxColumn extends DataSpreadsheetColumn {
    ...
    renderContent(record) {
        return { tag: 'input', type: 'checkbox', checked: !!this.rawValue(record), tabindex: '-1' }
    }

    valueFor(record) { return this.rawValue(record) ? 'true' : 'false' }
    ...
    toggle(record) {
        if (this.editable && this.attribute != null) {
            record[this.attribute] = !this.rawValue(record)
        }
    }
