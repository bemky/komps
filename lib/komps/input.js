...
export default class Input {
    ...
    async _load (e, v) {
        this.input.value = this.load(v ? v : await this.record[this.attribute])
    }
...
class BinaryInput extends Input {
    async _load () {
        const value = this.load(await this.record[this.attribute])
...
class DateInput extends Input {
    ...
    async _load (e) {
        let value = await this.record[this.attribute]
...
class SelectInput extends Input {
    ...
    async _load (e) {
        if (this.input.multiple) {
            const values = this.load(await this.record[this.attribute]);
